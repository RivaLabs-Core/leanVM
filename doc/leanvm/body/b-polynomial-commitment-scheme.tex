...
\item the prover can thus preprocess the sponge state after hashing the whole $128$-byte blocks of those zeros, and then hash the rest of each leaf starting from this state.
\end{itemize}
