...
\begin{gather*}
  \opc{XOR64}=\gen^{0},\quad \opc{MUL64}=\gen^{1},\quad \opc{SET}=\gen^{2},\\
  \opc{DRF}=\gen^{3},\quad \opc{JMP}=\gen^{4},\quad \opc{B2S}=\gen^{5}.
\end{gather*}
