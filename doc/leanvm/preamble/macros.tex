...
% ---------- VM ----------
\newcommand{\loc}[1]{\mem[\fp+#1]}
\newcommand{\intk}[1]{\underline{#1}}   % the integer #1 as the element of K with those bits
\newcommand{\fpx}{\mathbf{fpx}}         % g^fp: the frame pointer's g-power, the third component of the VM state
\newcommand{\expa}{\mathbf{Exp}}        % the exponentiation array, entry i holding g^i
...
\newcommand{\meminit}{\mem^{\mathrm{init}}} % committed memory before the run
\newcommand{\memfin}{\mem^{\mathrm{fin}}}   % committed memory after the run
