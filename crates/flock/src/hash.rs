...
//! `out = keccak_f(in ⊕ END_BIT·e₁₆)` ([`primitives::hash::step`]), all 24 rounds
...
use primitives::hash::{END_BIT, END_LANE, PI, RC, RHO, ROUNDS, STATE_LANES};
